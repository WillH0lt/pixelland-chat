...
onMounted(async () => {
  ...
  if (import.meta.env.MODE === MODE.PROD) {
    ...
    await connectUser({
      name: 'will',
      bio: `https://kristrocity.carrd.co/
    pansexual, trans, he/them
    (Commissions open btw)
    discord: Kris(py Kreme)#5274
    Signature colour: #C386FF
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    average spriters resource copy-er
    i have autisim
    i usually work in the negative void`,
